...
public class Ellipse implements Shape {
	...
	private Color color;
	private String identifier;		// used to identify shape

	/**
	 * An "empty" ellipse, with only one point set so far
	 * set all four points, the color, and the identifier
	 */
	public Ellipse(int x1, int y1, Color color, String identifier) {
	 ...
	 * set all four points, the color, and the identifier
	 */
	public Ellipse(int x1, int y1, int x2, int y2, Color color, String identifier) {
	...
	public String toString() {
		return "ellipse "+x1+" "+y1+" "+x2+" "+y2+" "+color.getRGB() + " " + identifier;
	}
